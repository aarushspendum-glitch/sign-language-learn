    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
          <Link href="/learn" className="hover:text-teal-600 transition-colors">Modules</Link>
          {session && (
          ...
          {session ? (
            <div className="flex items-center gap-3">
              <img
                ...
                alt="avatar"
                className="w-9 h-9 rounded-full border-2 border-teal-200 shadow-sm"
              />
              <button
                onClick={() => signOut()}
            ...
            <button
              ...
              className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 text-sm font-semibold px-4 py-2 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm"
            >
